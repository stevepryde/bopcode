    ...
    <div className="flex flex-col gap-5 h-full overflow-auto p-1">
      ...
      <div>
        <div className="flex items-baseline gap-2 mb-2">
          ...
          <span className="text-xs text-zinc-500">Sets the color scheme for the level header</span>
        </div>
          ...
          {THEME_OPTIONS.map(({ id, label, gradient }) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md border transition-colors cursor-pointer ${
                  isSelected
